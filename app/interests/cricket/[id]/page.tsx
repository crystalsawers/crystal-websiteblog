...
export async function generateMetadata({
  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      const cleanDescription = data.content
        ...
        : 'Check out this cricket post';

      return {
        title: data.title || 'Cricket Post',
            ...
            ? [
                {
                  ...
                  width: 1200,
                  height: 630,
                  alt: data.title || 'Cricket post image',
                },
              ]
            : [
                {
  ...
  return {
    title: 'Cricket Post',
    description: 'Check out this cricket post',
    openGraph: {
      siteName: 'Log, Lap, and Over',
    },
  };
...
const CricketItem = () => {
  return <ItemPage collectionName="cricket" />;
};
