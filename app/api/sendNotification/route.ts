  ...
  if (postTitle.startsWith('NEW POST:')) {
    try {
      ...
      const mailOptions = {
        ...
        subject: `${postTitle}`,
        text: `Check out my new post here: ${postUrl}, and click the link to read it! It would help me out a lot if you read it and share it with your friends and family.`,
      };
