...
export async function generateMetadata({
  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      const cleanDescription = data.content
        ...
        : 'Check out this apps project';

      return {
        title: data.title || 'Apps Project',
            ...
            ? [
                {
                  ...
                  width: 1200,
                  height: 630,
                  alt: data.title || 'Apps project image',
                },
              ]
            : [
                {
  ...
  return {
    title: 'Apps Project',
    description: 'Check out this apps project',
    openGraph: {
      siteName: 'Log, Lap, and Over',
    },
  };
...
const AppsItem = () => {
  return <ItemPage collectionName="apps" />;
};
