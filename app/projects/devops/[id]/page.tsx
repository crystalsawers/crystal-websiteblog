...
export async function generateMetadata({
  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      const cleanDescription = data.content
        ...
        : 'Check out this DevOps project';

      return {
        title: data.title || 'DevOps Project',
            ...
            ? [
                {
                  ...
                  width: 1200,
                  height: 630,
                  alt: data.title || 'DevOps project image',
                },
              ]
            : [
                {
  ...
  return {
    ...
    description: 'Check out this DevOps project',
    openGraph: {
      siteName: 'Log, Lap, and Over',
    },
  };
...
const DevOpsItem = () => {
  return <ItemPage collectionName="devops" />;
};
